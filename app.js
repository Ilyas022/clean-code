...
var taskInput=document.getElementById("new-todo__text");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add("todos-list__item")
    ...
    checkBox.classList.add('toggler')
    editInput.type="text";
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".toggler");
